<body>
    <div class="page-40">
        <div class="type-2-page-40-overlap-group-wrapper">
            <div class="type-2-page-40-overlap-group">
                ...
                <p class="in-conclusion-name">
                    ...
                    behaviors.
                    <br /><br />
                    Furthermore, the practical advice on how to use the Enneagram for personal and professional
                    development, as well as analyzing compatibility with other personality types, can <span
                        class="page-40-page-40-text-wrapper-3">help you improve your relationships, achieve your goals,
                        and enhance your overall well-being.</span>
                    <br /><br />
                    Overall, this ebook is an excellent resource for anyone looking to explore their personality,<span
...
<style>
<?php include 'pages/type-2/page-40/style.css';
?>
</style>